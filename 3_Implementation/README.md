...
void main()
{
	...
	{	printf("		!! SNAKE & LADDER GAME!! \n		Coded By Surya \n");
		...
		printf("1. Candidate 1 plays\n");
		printf("2. Candidate 2 plays\n");
		printf("3. Exit\n");
		scanf("%s",&ch);
		...
		switch(ch)
		{
			...
			system("cls");
					...
					if(cur_pos1<101){
						...
						printf("Range exceeded of Candidate 1.\n");
						displaychart(cur_pos1,"$P1$");
					}
					printf("Candidate 2 position is %d\n",cur_pos2);
			...
			system("cls");
					...
					if(cur_pos2<101){
						...
						printf("Range exceeded of Candidate 2.\n");
						displaychart(cur_pos2,"$P2$");
					}
					printf("Candidate 1 position is %d\n",cur_pos1);
				break;
			case '3':exit(0);
				break;
